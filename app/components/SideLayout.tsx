...
export function SideLayout({ children }: SideLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen bg-[#0d1117] dark:bg-[#0d1117] bg-gray-50 text-[#c9d1d9] dark:text-[#c9d1d9] text-gray-900 font-sans selection:bg-[#2f81f7]/30">
      ...
      {/* Sidebar Navigation */}
      <aside className={`
        fixed lg:sticky top-0 left-0 z-50 h-screen w-72 bg-[#0d1117] dark:bg-[#0d1117] bg-white border-r border-[#30363d] dark:border-[#30363d] border-gray-200 p-6 flex flex-col gap-8 transition-transform duration-300
      ...
      `}>
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setIsSidebarOpen(false)} className="lg:hidden text-[#8b949e] dark:text-[#8b949e] text-gray-600 p-2">
            <X size={24} />
          </button>
        </div>
